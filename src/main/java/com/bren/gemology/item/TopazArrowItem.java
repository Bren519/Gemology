...
public class TopazArrowItem extends ArrowItem {
    ...
    public TopazArrowItem(Properties p_40512_, float damage) {
        super(p_40512_);
        this.damage = damage;
    }
    ...
    public AbstractArrow createArrow(Level p_40513_, ItemStack p_40514_, LivingEntity p_40515_) {
        TopazArrow arrow = new TopazArrow(p_40515_, p_40513_);
    ...
    public boolean isInfinite(ItemStack stack, ItemStack bow, Player player) {
        ...
        return enchant <= 0 ? false : this.getClass() == TopazArrowItem.class;
    }
}
